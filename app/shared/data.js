(function () {
  ...
  // Минимальные характеристики тягачей по числу осей. Эти данные используются для расчёта
  // допустимой полной массы состава и остаточной грузоподъёмности. Значения взяты
  // ориентировочно: пустая масса (tareKg), максимальная разрешённая масса состава
  // (grossLimitKg) и нормативные лимиты на каждую ось (axleLimits). При необходимости
  // их можно скорректировать.
  const BASE_TRACTOR_LIMITS = {
    "2": {
      axles: 2,
      tareKg: 8200,        // масса пустого 2‑осного тягача, кг
      grossLimitKg: 18000, // максимальная допустимая полная масса состава, кг
      axleLimits: [7500, 11500] // лимиты для осей: передняя, задняя
    },
    "3": {
      axles: 3,
      tareKg: 8600,        // масса пустого 3‑осного тягача, кг
      grossLimitKg: 26000, // максимальная допустимая полная масса состава, кг
      axleLimits: [7500, 11500, 11500] // лимиты для осей: передняя, задняя 1, задняя 2
    }
  };

   window.vigardData = { BASE_PRODUCTS, BASE_TRUCKS, BASE_TRAILERS, BASE_TRACTOR_LIMITS };
})();